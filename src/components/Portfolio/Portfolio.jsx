...
const JQueryIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
      <path
        fill="#0868AC"
        d="M27.758 20.421c-7.352 10.565-6.437 24.312-.82 35.54l.411.798.263.506.164.291.293.524c.174.307.353.612.536.919l.306.504c.203.326.41.65.622.973l.265.409c.293.437.592.872.901 1.301l.026.033.152.205c.267.368.542.732.821 1.093l.309.393c.249.313.502.623.759.934l.29.346c.345.406.698.812 1.057 1.208l.021.022.041.045c.351.383.71.758 1.075 
    ...
    <div id="portfolio">
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p id="description">
            Developed an app for Your Path, a local business that is advocating
            for recovery-oriented care and treatment for those on the road to
            recovery. Their previous workflow for matching patients with
            providers was using an excel spreadsheet and a significant amount of
        ...
        >
          ...
          <p id="description">
            A feedback form built for Prime Digital Academy to assess how their
            students are processing their immersive education.
          </p>
          <Button
            variant="outlined"
            onClick={() =>
        ...
        >
          ...
          <h3 className="vertical-timeline-element-title">Cafe Java</h3>
          <p id="description">
            A custom web application being developed for the local coffee shop,
            Cafe Java!
          </p>
          <Button
            variant="outlined"
            onClick={() =>
              window.open("https://github.com/MMettille/cafe-java")
            }
          >
            See the Code
          </Button>
        ...
        >
          ...
          <p id="description">
            A simple mathmatical calculator with the option to customize your
            background coloring.
          </p>
          <Button
            variant="outlined"
        ...
        >
          ...
          <p id="description">
            ...
            use a "like" button to track and display the total number of likes
            that a photo has, and to use conditional rendering to display a
            description of the photo when clicked.
          </p>
          <Button
            variant="outlined"
            onClick={() =>
        ...
        >
          ...
          <p id="description">
            A Giphy searching and favoriting application which allows the user
            to save images and sort them into categories - built within a team
            of four!
          </p>
          <Button
            variant="outlined"
            onClick={() =>
              window.open(
                "https://github.com/MMettille/group-giphy-saga-project"
              )
            }
          >
            See the Code
